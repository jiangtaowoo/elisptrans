...
class WordTranslateResult(object):
    ...
    def parse_result_from_rsp(self, rsp):
        ...
        try:
            ...
            print("parse rsp except {0}".format(e))
            return None
    ...
    def _translate_request(sess, req_dict, js_dict, word, sentence, srclang):
        ...
        if not word_in_dict:
            ...
            try:
                ...
                print("translate_req except {0}".format(e))
                return None
        else:
            return word_obj.gen_flashcard_format()
    ...
    def translate_worker(self, workerid, params):
        while self.words_tobe_t:
            ...
            if word:
                ...
                if not result:
                    print(u'****** Worker {0} failed on line {1}: {2} ...'.format(workerid, line, word))
                    gevent.sleep(5)
                else:
                    print(u'Woker {0} is traslate line {1} successful: {2}...'.format(workerid, line, word))
            else:
                gevent.sleep(0)
